...
import { candidateNav } from './navConfig';

const HOME   = '/candidate/dashboard';
...
export function CandidateShell() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'rgb(var(--color-bg))' }}>
      <Navbar navItems={candidateNav} homeUrl={HOME} profileUrl={PROFILE} />
      <OfflineBanner />
      <div className="flex">
        <div className="hidden md:block w-16 flex-shrink-0" />
        <IconRail navItems={candidateNav} />
