...
const c = compareBySlug("codility")!;

export const metadata: Metadata = {
  title: "Prelim vs. Codility – Which Assessment Platform Is Right for You?",
  description:
    "Codility sets the bar for realistic coding environments. Prelim sets the bar for enterprises that also assess leaders and every non-technical function. See the full comparison.",
  alternates: { canonical: "/compare/codility/" },
};

export default function CodilityComparePage() {
  if (!c) notFound();
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: "Prelim vs. Codility", href: "/compare/codility/" },
      ]} />
          ...
          <table className="ct">
            <thead>
              <tr>
                ...
                <th className="ct-bad">Codility</th>
              </tr>
            </thead>
            <tbody>
              {c.rows.map((r) => (
      ...
      <Band tint>
        <div className="split rv">
          ...
          <div>
            <SectionHead title="Choose Codility if…" />
